...
ActiveRecord::Schema.define() do
  ...
  create_table "paper_mastercards", :force => true do |t|
    t.column "arvnumber",         :string,  :limit => 50,  :default => "", :null => false
    t.column "fieldid",           :string,  :limit => 100, :default => "", :null => false
    t.column "fieldvalue",        :string,  :limit => 100, :default => "", :null => false
    t.column "entry",             :string,  :limit => 1,   :default => "", :null => false
    t.column "mastercard_number", :integer, :limit => 2
  ...
  create_table "role_role", :id => false, :force => true do |t|
    t.column "parent_role_id", :integer, :null => false
    t.column "child_role_id",  :integer, :null => false
  end
